...
[中文](README_cn.md) · [Concise entry](README.md) · [Curated knowledge base](curated_project/README.md) · [Documentation](docs/README.md)
...
[curated result index](curated_project/00_从这里开始/RESULTS.md) and the
[machine-readable registry](docs/curation/RESULT_REGISTRY.csv).
...
| Need | Entry point |
|---|---|
| Current status and result boundaries | [Curated knowledge base](curated_project/README.md) |
...
| Current technical master report | [2026-08-12 technical draft](reports/SOFTWARE_PROGRESS_AND_TECHNICAL_DRAFT_2026-08-12.md) |
| Current global actions | [docs/TODO.md](docs/TODO.md) |
| Numerical and document conflicts | [CONFLICTS.md](docs/curation/CONFLICTS.md) |
...
scripts/                    PBS, experiment, and batch launchers
docs/                       stable guides, protocols, status, and history
reports/                    current reports, negative results, milestones
curated_project/            small curated knowledge copy without large outputs
output*/ validation/ ...    raw and derived evidence; not source-code directories
references/                 papers and external references
archive/                    retired patches and historical material
```
...
[immutability policy](docs/curation/IMMUTABILITY_POLICY.md).
