...
[English](README_en.md) · [简明入口](README.md) · [整理版知识库](curated_project/README.md) · [完整文档](docs/README.md)
...
[整理版结果索引](curated_project/00_从这里开始/RESULTS.md)和
[机器可读结果登记表](docs/curation/RESULT_REGISTRY.csv)为准。
...
| 目标 | 入口 |
|---|---|
| 快速理解当前状态和结果边界 | [整理版知识库](curated_project/README.md) |
...
| 当前综合进度与论文母稿 | [2026-08-12 技术底稿](reports/SOFTWARE_PROGRESS_AND_TECHNICAL_DRAFT_2026-08-12.md) |
| 当前行动 | [docs/TODO.md](docs/TODO.md) |
| 数字冲突与有效性 | [CONFLICTS.md](docs/curation/CONFLICTS.md) |
...
tests/                      回归与协议测试
tools/                      诊断、显式修复和绘图
scripts/                    PBS、实验和批处理入口
docs/                       稳定教程、协议、状态与历史文档
reports/                    综合报告、负结果与阶段记录
curated_project/            不含大型输出的整理版知识副本
output*/ validation/ ...    原始/派生计算证据；不是源码目录
references/                 外部论文与参考材料
archive/                    历史补丁和退役材料
```
...
bug 根因。详细政策见 [IMMUTABILITY_POLICY.md](docs/curation/IMMUTABILITY_POLICY.md)。
...
- 稳定教程写入 `docs/`；体系与日期相关结论写入 `reports/` 或结果登记表。
- 当前解释以最新综合报告、源码和 sealed protocol 为准；旧 `docs/status/` 是历史快照。
