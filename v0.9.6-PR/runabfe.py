...
def main():
    ...
    complex_results = pipeline.run_full_pipeline(
        ...
        refine_overlap=config.get("refine_overlap", 2),
        pilot_finite_difference_delta=config.get("pilot_finite_difference_delta", 0.01),
        pilot_max_window_thermodynamic_length=config.get(
            "pilot_max_window_thermodynamic_length", 6.0
        ),
        pilot_overlap_thermodynamic_length=config.get(
            "pilot_overlap_thermodynamic_length", 1.5
        ),
        pilot_max_states_per_window=config.get("pilot_max_states_per_window", 6),
