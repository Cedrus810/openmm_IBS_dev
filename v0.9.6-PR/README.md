...
更详细的方法学缺陷、工程审计遗留项和修复状态见 `AUDIT_STATUS.md`；旧的 `PHYSICS_DEFECTS.md`、`RELEASE_AUDIT_REMAINING.md` 和 `RE_AUDIT_2026-07-10.md` 仅作为兼容性存根保留。
...
AUDIT_STATUS.md         当前权威审计状态：物理/建模问题、修复历史和工程审计记录
