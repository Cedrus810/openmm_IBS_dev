...
def test_cli_requires_explicit_paths_and_writes_requested_output(tmp_path):
    ...
    # 2026-09-10 搬进主线：原来指的是 rank11 根目录那三份 PLAN/IMPLEMENTATION/
    # EXPERIMENT_LOG_outer_lambda_neural_basis.md，发布整理时没随过来。这里要的
    # 只是"三个仓库里确实存在、有稳定 sha 的文件"当不透明产物的替身，内容无关。
    fixture_paths = {
        "topology": ROOT / "README.md",
        "base_system": ROOT / "NOTICE",
        "box": ROOT / "LICENSE",
    }
