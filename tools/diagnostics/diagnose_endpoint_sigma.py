...
----
    ...
    python tools/diagnostics/diagnose_endpoint_sigma.py --run-dir output_lrc_fix --out-dir /tmp/sigma_diag
"""
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--run-dir", default="output_lrc_fix", help="生产输出目录（只读）")
