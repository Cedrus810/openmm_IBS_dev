...
用法::
    ...
    python tools/diagnostics/diagnose_estimator_matrix.py --run-dir output_lrc_fix \\
        --attachment-dir output_lrc_fix/attachment_rerun/20260728_154400
"""
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--run-dir", default="output_lrc_fix")
