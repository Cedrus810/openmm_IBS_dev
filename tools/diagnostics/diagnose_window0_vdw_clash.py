...
用法：
    python tools/diagnostics/diagnose_window0_vdw_clash.py --output-dir ./output_lrc_fix --n-steps 20000 \
        --lambda-shield 1.0 --clash-threshold-kj-mol 20 --platform CUDA
    python tools/diagnostics/diagnose_window0_vdw_clash.py --output-dir ./output_lrc_fix --n-steps 20000 \
        --lambda-shield 0.9843 --clash-threshold-kj-mol 20 --platform CUDA
    python tools/diagnostics/diagnose_window0_vdw_clash.py --output-dir ./output_lrc_fix --skip-md \
        --lambda-shield 1.0
"""
