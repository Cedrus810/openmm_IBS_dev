...
[中文完整说明](README_cn.md) · [Full English README](README_en.md) · [整理版知识库](curated_project/README.md) · [文档导航](docs/README.md)

ABFE-IBS 是一个基于 OpenMM、面向 GROMACS 输入的绝对结合自由能工作流。本仓库还包含
Atenolol-rank11 参考体系、验证数据，以及成功、失败和已失效路线的完整开发记录。
...
- 当前状态、数字结论与历史关系：[整理版知识库](curated_project/README.md)
...
原始 `output*`、验证轨迹、checkpoint、日志和历史结论均为证据；文档整理不删除或原地改写它们。
